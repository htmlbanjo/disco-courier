...
| `courier -- --export=read --results=5 --actor=3 --conversant=8 conversations.dialog`                               | Creates a markdown-friendly table of the first five instances of Jean Viqmarc dialog.                                                                                                              |
